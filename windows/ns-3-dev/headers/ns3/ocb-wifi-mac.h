...
private:
  ...
  bool m_macExtensionSupport;
  void SetMacExtensionSupported (bool enable);
  bool GetMacExtensionSupported (void) const;
   ...
   */
  void CreateWaveEdcaQueue (enum AcIndex ac);

  void CreateWaveMacLow (void);
